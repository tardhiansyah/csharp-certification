/*
    ...
    - Add predefined sample data to the pests array.
    ...
    - Display all the information contained in the array used to store pet data (basedon user's menu selection).
    - Iterate an "add mew animal information" code block that enables the user to add one or more new animals to the pets
      array (based on user's menu selection).

    PROJECT OVERVIEW
    1. Create a C# console application
    2. Store application data in multidimensional string array named: ourAnimals
    3. The ourAnimals array includes the following "pet characteristics" for each animal:
        - Pet ID #
        ...
        - The pet's name
    4. Implement a sample dataset that represents dogs and cats currently in your care
    5. Display menu option to access the main features of the application such as:
