...
foreach (string name in studentNames)
{
    ...
    int gradedExtraCreditAsssignments = 0;
    ...
    */
    foreach (int score in studentScores)
    {
        ...
        {
            gradedExtraCreditAsssignments += 1;
            sumExtraCreditScores += score;
        }
    }

    currentStudentExamScore = (decimal)sumExamScores / examAssignments; 
    currentStudentExtraCreditScore = (decimal)sumExtraCreditScores / gradedExtraCreditAsssignments;

    currentStudentGrade = (sumExamScores + ((decimal)sumExtraCreditScores / 10)) / examAssignments;
    
    decimal sumAssignmentScores = sumExamScores + (sumExtraCreditScores / 10);
