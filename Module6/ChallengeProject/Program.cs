...
while (transactions > 0)
{
    ...
    int paymentOnes = itemCost % 2 == 0;                 // value is 1 when itemCost is odd, value is 0 when itemCost is even
    int paymentFives = (itemCost % 10 > 7 && itemCost % 10 <= 9) ? 1 : 0; // value is 1 when itemCost ends with 8 or 9, otherwise value is 0
    int paymentTens = ((itemCost % 20 > 13 && itemCost % 20 < 20) || (itemCost % 20 > 33 && itemCost % 20 < 40)) ? 1 : 0; // value is 1 when 13 < itemCost < 20 OR 33 < itemCost < 40, otherwise value is 0
...
Console.WriteLine($"Total Transaction: {100 - transactions}");
