...
// sample data ourAnimals array data entries
    ...
    switch (menuSelection)
    {
        ...
        case "2":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                ...
                if (ourAnimals[i, 4] != "Physical description: " || ourAnimals[i, 5] != "Personality: ")
                {
                ...
                {
                    Console.WriteLine($"Dog {ourAnimals[i, 3]}");
                    Console.WriteLine($"Dog {ourAnimals[i, 4]}");
                    Console.WriteLine($"Dog {ourAnimals[i, 5]}");
